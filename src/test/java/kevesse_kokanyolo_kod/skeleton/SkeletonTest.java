...
public class SkeletonTest {
    ...
    public static void startCall(String methodHeader) throws IOException {
    ...
    public static void endCall(String result) throws IOException {
    ...
    public static void endCall() throws IOException {
